...
import com.arjun.tracker_data.repository.TrackerRepositoryImp
...
abstract class TrackerDataModule {
    ...
    @Binds
    abstract fun bindsTrackerRepository(trackerRepositoryImp: TrackerRepositoryImp): TrackerRepository
    ...
    companion object {
        ...
        @Provides
        fun providesOpenApi(retrofit: Retrofit): OpenFoodApi =
